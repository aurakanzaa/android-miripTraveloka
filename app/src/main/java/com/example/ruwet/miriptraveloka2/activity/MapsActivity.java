...
import com.example.ruwet.miriptraveloka2.maps.GetMapsActivity;
...
import com.example.ruwet.miriptraveloka2.maps.DataParser;
import com.example.ruwet.miriptraveloka2.maps.DownloadUrl;
import com.example.ruwet.miriptraveloka2.maps.GetMapsActivity;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnHotels = (Button) findViewById(R.id.btnHotels);
        btnHotels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataTransfer[1] = url;
                Log.d("onClick", url);
                GetMapsActivity getNearbyPlacesData = new GetMapsActivity();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby University",
